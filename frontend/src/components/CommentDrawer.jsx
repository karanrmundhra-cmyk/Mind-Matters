...
export default function CommentDrawer({
  ...
  // Inline popover (v2.24) — anchored next to the comment icon
  if (anchor) {
    return (
      <AnchoredPanel
        anchor={anchor}
        ...
        width={420}
        maxHeight="70vh"
        testId="comment-drawer"
      >
        <div className="flex flex-col h-full min-h-[260px]">{content}</div>
      </AnchoredPanel>
    );
  }

  // Legacy full-height right drawer (kept as fallback for non-anchored callers)
  return (
    <div
